...
const checkInBetween = (date_string: string[], c_date: Date, months: string[]) => {
...
const whatweek = (date_string: string[], c_date: Date, months: string[]) => {
	const beginning_date = date_string[0];
	const beginning_month = months.indexOf(date_string[1]);
...
@ApplyOptions<Command.Options>({
	description: 'Tells you what week of the trimester it is!'
})
export class WhatWeekIsItCommand extends Command {
