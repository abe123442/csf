...
export class FaqCommand extends Command {
	...
	private commandFAQHelp = new SlashCommandSubcommandBuilder().setName('help').setDescription('Get some information about the help command');
	...
	private commandFAQGetTags = new SlashCommandSubcommandBuilder().setName('tags').setDescription('Get all tags that exist for current FAQs');
